...
public class GatewayOrderQueryRequest  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new QName("http://gatewayquery.dto.domain.seashell.bill99.com", "GatewayOrderQueryRequest"));
        ...
        elemField.setXmlName(new QName("", "inputCharset"));
        elemField.setXmlType(new QName("http://schemas.xmlsoap.org/soap/encoding/", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new ElementDesc();
        ...
        elemField.setXmlName(new QName("", "queryMode"));
        ...
        elemField.setXmlName(new QName("", "requestPage"));
        elemField.setXmlType(new QName("http://schemas.xmlsoap.org/soap/encoding/", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new ElementDesc();
