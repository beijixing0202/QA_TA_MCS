...
public class GatewayBankPay extends BaseTestCase {
	@Autowired
	...
	@Test(description = "人民币网关银行卡支付", dataProvider = "gatewayBankPay", timeOut = 600000, enabled = true)
	public void gatewayBankPay(Map<String, String> data) throws Exception {
		...
		if (payResult) {
			...
			Reporter.log(data.get("name"), gatewayDbCheck.checkGatewayDeal(data, 4) && logDbCheck.notifyLogDbCkeck(data)&&gatewayDbCheck.checkAcctItermsBank(data));
	...
	@DataProvider(name = "gatewayBankPay")
	public Iterator<Object[]> data4test() throws IOException {
		return ExcelProviderByEnv(this, "gatewayBankPay");
	}
}
