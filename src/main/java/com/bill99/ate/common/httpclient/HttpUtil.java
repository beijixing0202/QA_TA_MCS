...
public class HttpUtil {
	 ...
	 * @return
	 * @throws IOException
	 * @Description:请求为json格式的http请求
	 */
	public String postJson(String json, Map<String, String> header, String url) throws IOException {
		...
		try {
			...
			reqEntity = new ByteArrayEntity(json.getBytes(charsetName));
			httpPost.setEntity(reqEntity);
			httpResponse = client.execute(httpPost);
			entity = httpResponse.getEntity();
			String responseString = IOUtils.toString(entity.getContent(), charsetName);
			if (httpResponse.getStatusLine().getStatusCode() == HttpURLConnection.HTTP_OK) {
				return responseString;
			} else {
				throw new IOException(
						httpResponse.getStatusLine().toString() + " ERROR\nResponseText=" + responseString);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public String postJson(String json, String url) throws IOException {
		return postJson(json, null, url);
	}
	
	public String getJson(Map<String, String> queryParams, Map<String, String> header, String url) throws URISyntaxException, ClientProtocolException, IOException {
		...
		InputStream inputStream =  response != null ? response.getEntity().getContent() : null;
		return HttpUtil.readStream(inputStream, null);
	...
	public static void main(String[] args) throws ClientProtocolException, URISyntaxException, IOException {
		...
		System.out.println(new HttpUtil().doGetForString("http://192.168.14.88:8088/cap-mock/loginServlet",map));
		System.out.println(getInstance().doGetForString("http://192.168.14.88:8088/cap-mock/mdpCenter.jsp"));
	}
