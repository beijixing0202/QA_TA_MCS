 ...
 *
 */
public class MgwAmtPointPay extends BaseTestCase {	
	...
	// 平安积分支付
	@Test(dataProvider = "mgwAmtPointPay",description="平安积分支付",timeOut=100000)
	public void amtPointPay(Map<String, String> datadriven) {
	...
	// 数据库检查，如果预期结果与实际结果一致 并且是正常流程，数据库检查
		if (a1 && datadriven.get("comment").equalsIgnoreCase("平安积分支付正常流程")) {
...
@DataProvider(name = "mgwAmtPointPay")
public Iterator<Object[]> data1test() throws IOException {
	return ExcelProviderByEnv(this, "mgwAmtPointPay");
}
